...
def test_resolve_searches_composition_uses_explicit_list(tmp_path):
    assert resolve_searches_composition(tmp_path, ["Pt", "Au"]) == ["Pt", "Au"]


def test_resolve_searches_composition_infers_from_final_unique_minima(tmp_path):
